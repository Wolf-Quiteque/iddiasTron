...
const SettingsDeletedAccount = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.settingsDeletedAccountView}>
      ...
      <View style={[styles.popOverView, styles.mt_30]}>
        <Text style={styles.yourAccountHasBeenSuccessf}>
          <Text style={styles.yourAccountHas}>Your account has been</Text>
      ...
      <View style={[styles.recentSearchesView, styles.mt_124, styles.ml1]}>
...
export default SettingsDeletedAccount;
